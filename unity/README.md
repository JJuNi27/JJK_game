...
- 기본 공격은 1타·2타·3타로 이어지며 3타의 피해, 경직, 넉백이 가장 큼
- 콤보 입력 시 화면 상단 중앙에 현재 콤보 단계 표시
...
- 플레이어가 이동할 수 있음
- 좌클릭 연속 입력으로 3타 콤보가 진행됨
- 콤보 입력을 늦게 하면 다시 1타부터 시작됨
...
```text
Assets/Scripts/Core/
- 체력, 전투 HUD, 승패, 공통 인터페이스

Assets/Scripts/Player/
- 이동, 3타 기본 공격, 고죠 영역 입력, 무량공처 임시 시각효과

Assets/Scripts/Enemy/
- 단순 주령 상태 머신, 경직·넉백·점멸 반응
