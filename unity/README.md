...
- Q를 누르면 고죠 주변 약 8m 범위에 청색 원형 효과가 펼쳐집니다.
- 범위 안의 주령에게 소량의 피해와 짧은 경직을 주고 고죠 쪽으로 끌어당깁니다.
- 기본 재사용 대기시간은 3.2초이며 화면 왼쪽에 쿨타임이 표시됩니다.
- 영역전개 입력 중에는 사용할 수 없습니다.
- 원작 기술명을 사용하지만 현재 수치, 범위, 키 배치는 `GAME_ORIGINAL` 전투 프로토타입입니다.
...
- 이동, 회피, 3단 공격 연계, 적중 콤보, 고죠 창, 영역 입력, 무량공처 임시 시각효과
