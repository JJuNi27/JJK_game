Shader "JJKGame/Exploration/Purple OuterR2 Background Distortion"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(V i):SV_Target
            {
                ...
                float2 offset=turbulence*_Field.y*mask*(.35+patch)*pulse*float2(_ScaledScreenParams.y/_ScaledScreenParams.x,1);
