...
namespace JJKGame.Dev.PurpleBodyExploration
{
    ...
    public sealed class PurpleOuterR2Runtime : MonoBehaviour
    {
        private PurpleOuterR2Profile profile;
        ...
        public void Configure(PurpleOuterR2Profile settings,float diameter)
        {
            ...
            haloMaterial=new Material(Resources.Load<Shader>("VFX/PurpleOuterR2Halo")){name="PurpleOuterR2_Halo_Runtime"};
            ...
            particleMaterial=new Material(Resources.Load<Shader>("VFX/PurpleOuterR2Particle")){name="PurpleOuterR2_Particle_Runtime"};
            ...
            arcMaterial=new Material(particleMaterial){name="PurpleOuterR2_ArcParticles_Runtime"};
            ...
            distortionMaterial=new Material(Resources.Load<Shader>("VFX/PurpleOuterR2Distortion")){name="PurpleOuterR2_Distortion_Runtime"};
        ...
        {
            var mesh=new Mesh{name="PurpleOuterR2_Shard_Runtime"};
        ...
        {
            var mesh=new Mesh{name="PurpleOuterR2_UnitSegment_Runtime"};
        ...
        private void SampleDebris(float time)
        {
            ...
            for(int i=0;i<profile.heroFragments && count+4<=sparks.Length;i++)
            {
                ...
                float life=.39f+Hash(seed+5)*.10f;if(age>life)continue;
                Vector3 direction=Direction(seed),side=Vector3.Cross(direction,Vector3.up).normalized;
