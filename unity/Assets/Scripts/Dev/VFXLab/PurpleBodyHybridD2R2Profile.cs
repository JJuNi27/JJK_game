...
{
    [CreateAssetMenu(menuName="JJK Game/시각 탐색/Purple D2-R2 설정")]
    public sealed class PurpleBodyHybridD2R2Profile : ScriptableObject
    {
        public PurpleBodyHybridD2R1Profile frozenR1;
        ...
        [Range(.015f,.12f)] public float arcRadius=.07f;
