...
{
    public sealed class PurpleBodyHybridD2R3Prototype : MonoBehaviour
    {
        private const int ArcCount=8,Rings=32,Sides=7;
        private PurpleBodyHybridD2R3Profile profile;
        ...
        public void Configure(PurpleBodyHybridD2R3Profile settings)
        {
            profile=settings;diameter=settings.frozenR2.frozenR1.frozenD2.preservedD.commonConditions.bodyDiameter;unit=diameter/.75f;
            ...
            bodyMaterial=new Material(Resources.Load<Shader>("VFX/HollowPurpleHybridD2R3")){name="PurpleHybridD2R3_Body_Runtime"};
            ...
            arcMaterial=new Material(Resources.Load<Shader>("VFX/HollowPurpleHybridD2R3Arc")){name="PurpleHybridD2R3_Arc_Runtime"};
            arcMesh=new Mesh{name="R3_TubeArcs_Runtime"};arcMesh.MarkDynamic();arcs.AddComponent<MeshFilter>().sharedMesh=arcMesh;
